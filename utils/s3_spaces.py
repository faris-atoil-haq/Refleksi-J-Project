...
class AWS_S3:
    def __init__(self):
        ...
        self.client = session.client('s3',
            ...
            aws_access_key_id=settings.AWS_ACCESS_KEY, # Access key pair. You can create access key pairs using the control panel or API.
            aws_secret_access_key=settings.AWS_SECRET_KEY # Secret access key defined through an environment variable.
        )
